 ...
 */
class AdvertSkill extends \Salim\PlateformeBundle\Entity\AdvertSkill implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Salim\\PlateformeBundle\\Entity\\AdvertSkill' . "\0" . 'id', '' . "\0" . 'Salim\\PlateformeBundle\\Entity\\AdvertSkill' . "\0" . 'level', '' . "\0" . 'Salim\\PlateformeBundle\\Entity\\AdvertSkill' . "\0" . 'advert', '' . "\0" . 'Salim\\PlateformeBundle\\Entity\\AdvertSkill' . "\0" . 'skill'];
        }
