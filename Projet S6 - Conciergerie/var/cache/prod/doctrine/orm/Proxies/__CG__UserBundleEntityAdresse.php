 ...
 */
class Adresse extends \UserBundle\Entity\Adresse implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'UserBundle\\Entity\\Adresse' . "\0" . 'id', '' . "\0" . 'UserBundle\\Entity\\Adresse' . "\0" . 'num', '' . "\0" . 'UserBundle\\Entity\\Adresse' . "\0" . 'rue', '' . "\0" . 'UserBundle\\Entity\\Adresse' . "\0" . 'ville', '' . "\0" . 'UserBundle\\Entity\\Adresse' . "\0" . 'codePostal', '' . "\0" . 'UserBundle\\Entity\\Adresse' . "\0" . 'numAppart', '' . "\0" . 'UserBundle\\Entity\\Adresse' . "\0" . 'etage', '' . "\0" . 'UserBundle\\Entity\\Adresse' . "\0" . 'complements'];
        }
    ...
    public function setNumAppart($numAppart)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNumAppart', [$numAppart]);

        return parent::setNumAppart($numAppart);
    }
