...
class User extends \UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'entreprise', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'prestataire', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'salarie', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
     ...
     * {@inheritDoc}
     */
    public function setSalarie(\UserBundle\Entity\Salarie $salarie = NULL)
    {
     ...
     * {@inheritDoc}
     */
    public function setPrestataire(\UserBundle\Entity\Prestataire $prestataire = NULL)
    {
