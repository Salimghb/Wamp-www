 ...
 */
class Abonnement extends \ConciergerieBundle\Entity\Abonnement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ConciergerieBundle\\Entity\\Abonnement' . "\0" . 'id', '' . "\0" . 'ConciergerieBundle\\Entity\\Abonnement' . "\0" . 'dureeAbo', '' . "\0" . 'ConciergerieBundle\\Entity\\Abonnement' . "\0" . 'dateDebut', '' . "\0" . 'ConciergerieBundle\\Entity\\Abonnement' . "\0" . 'dateFin', '' . "\0" . 'ConciergerieBundle\\Entity\\Abonnement' . "\0" . 'bouquet', '' . "\0" . 'ConciergerieBundle\\Entity\\Abonnement' . "\0" . 'entreprise'];
        }
     ...
     * {@inheritDoc}
     */
    public function updateDate(\Doctrine\ORM\Event\LifecycleEventArgs $event)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'updateDate', [$event]);

        return parent::updateDate($event);
    }
    ...
    public function setDureeAbo($dureeAbo)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDureeAbo', [$dureeAbo]);

        return parent::setDureeAbo($dureeAbo);
    }
    ...
    public function getDureeAbo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDureeAbo', []);

        return parent::getDureeAbo();
    }
     ...
     * {@inheritDoc}
     */
    public function setBouquet(\ConciergerieBundle\Entity\Bouquet $bouquet)
    {
