 ...
 */
class EtatCommande extends \ConciergerieBundle\Entity\EtatCommande implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ConciergerieBundle\\Entity\\EtatCommande' . "\0" . 'id', '' . "\0" . 'ConciergerieBundle\\Entity\\EtatCommande' . "\0" . 'libelle', '' . "\0" . 'ConciergerieBundle\\Entity\\EtatCommande' . "\0" . 'commandes'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EtatCommande $proxy) {
