...
class appProdProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Projet\UserBundle\Form\RegistrationType A Projet\UserBundle\Form\RegistrationType instance
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \Projet\UserBundle\Form\RegistrationType();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('0KHLsB7h4d', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('C2YFobOV0w', 0, 'eXmjYU7zufzrb-hqAaAIRA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'projetS6', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\ConciergerieBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'ConciergerieBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('ConciergerieBundle' => 'ConciergerieBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d91d5ec948b92d28a58473a76d55780a08ddcd2e5cd2ff9de30749156315de37');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('noreply@conciergerie.com' => 'conciergerie'), 'resetting' => array('noreply@conciergerie.com' => 'conciergerie'))));
    }
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('fP7dxGM+Rb', NULL, 'eXmjYU7zufzrb-hqAaAIRA', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/entreprise');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/prestataire');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/salarie');
        ...
        $n->add($j, array(0 => 'ROLE_ENTREPRISE'), NULL);
        $n->add($k, array(0 => 'ROLE_PRESTATAIRE'), NULL);
        $n->add($l, array(0 => 'ROLE_SALARIE'), NULL);
        $n->add($m, array(0 => 'ROLE_ADMIN'), NULL);

        $o = new \Symfony\Component\Security\Http\HttpUtils($e, $e);

        $p = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $o, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($o, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        ...
        $q->setOptions(array('login_path' => 'fos_user_security_login', 'always_use_default_target_path' => true, 'default_target_path' => '/redirector', 'use_referer' => true, 'target_path_parameter' => '_target_path'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\ConciergerieBundle/Resources/views'), 'Conciergerie');
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ARhvhkjIwV', 0, 'eXmjYU7zufzrb-hqAaAIRA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('R050MPpvgG', 0, 'eXmjYU7zufzrb-hqAaAIRA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'ConciergerieBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ConciergerieBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ConciergerieBundle' => 'ConciergerieBundle\\ConciergerieBundle',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'noreply@conciergerie.com' => 'conciergerie',
            ),
