...
class RegistrationController extends Controller
{
    ...
    public function registerAction(Request $request, $role)
    {
        ...
        //On affecte un role à l'utilisateur selon la valeur de $role
        if ($role == 'Entreprise') {
        ...
        if ($form->isSubmitted()) {
            if ($form->isValid()) {
                ...
                //On affecte l'utilisateur a son specialiste
                if ($role == 'Entreprise') {
                  $user->getEntreprise()->setUser($user);
                }
                elseif($role =='Salarie'){
                  $user->getSalarie()->setUser($user);
                }
                elseif($role =='Prestataire'){
                  $user->getPrestataire()->setUser($user);
                }
    ...
    public function confirmedAction()
    {
        ...
        return $this->redirectToRoute('conciergerie_redirector');
    }
