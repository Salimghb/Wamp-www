...
INSERT INTO `entreprise` (`id`, `user_id`, `adresse_id`, `Siret`, `NbAbo`, `NbSal`, `Responsable`, `Telephone`, `Site`) VALUES
(1, 3, 1, 1061507308, 5, 3, 'Susan Masson', 662939453, 'gallet.fr'),
(2, 4, 2, 1116644887, 2, 5, 'Alphonse Pinto', 356646728, 'gautier.net'),
(3, 5, 3, 1152360423, 2, 2, 'Joséphine Bailly', 111535644, 'bonneau.org'),
(4, 6, 4, 1096572105, 1, 8, 'Madeleine Brunel', 515496826, 'ollivier.com'),
(5, 7, 5, 1171932636, 2, 2, 'Bernadette Menard', 297045898, 'jacques.com');
